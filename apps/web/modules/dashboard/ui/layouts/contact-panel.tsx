      ...
      <div className="flex flex-col gap-y-4 p-4">
        <div className="flex items-center gap-x-2">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <p className="line-clam-1 text-muted-foreground text-sm">
        ...
        {contactSession.metadata && (
          <Accordion className="w-full" collapsible type="single">
            {accordionSections.map((section) => (
              ...
              >
                <AccordionTrigger
                  className="flex w-full flex-1 items-start justify-between gap-4 rounded-none bg-accent px-5 py-4 text-left 
                font-medium text-sm outline-none transition-all hover:no-underline disabled:pointer-events-none disabled:opacity-50"
                >
